...
export default function Header(){
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity onPress={sidebarAction}>
        ...
        <Modal
          ...
          onRequestClose={sidebarAction}
        >
          <TouchableOpacity style={styles.overlay} onPress={sidebarAction}>
            <TouchableOpacity activeOpacity={1} style={styles.sidebarContainer}>
              ...
              <Text style={styles.username}>Emmanuella Animwaa Kumah</Text>
